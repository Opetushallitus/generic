 ...
 * TODO: tÃ¤tÃ¤ ei tarvittaisi mikÃ¤li cxf (soap) kutsuihin saisi http 'ticket' -parametrin mukaan headerin sijaan, kts. haku 'cxf querystring' tms
 * TODO: oldDeprecatedSecurity_REMOVE - lisÃ¤kustomointia tarvittu ettÃ¤ toimii vanhan autentikoinnin kanssa yhteen, siivoa myÃ¶hemmin
 *
 ...
 * When processing this URL, the value of {@link org.springframework.security.cas.ServiceProperties#getService()} is used as the <tt>service</tt> when validating
 * the <code>ticket</code>. This means that it is important that {@link org.springframework.security.cas.ServiceProperties#getService()} specifies the same value
 ...
 * a shared {@link org.jasig.cas.client.proxy.ProxyGrantingTicketStorage} between the {@link org.jasig.cas.client.validation.TicketValidator} and the CasAuthenticationFilter one can have the
 ...
 * tickets to get processed {@link org.springframework.security.cas.ServiceProperties#isAuthenticateAllArtifacts()} must return <code>true</code>. Additionally,
 * if the request is already authenticated, authentication will <b>not</b> occur. Last, {@link org.springframework.security.authentication.AuthenticationDetailsSource#buildDetails(Object)}
 * must return a {@link org.springframework.security.cas.web.authentication.ServiceAuthenticationDetails}. This can be accomplished using the {@link org.springframework.security.cas.web.authentication.ServiceAuthenticationDetailsSource}.
 * In this case {@link org.springframework.security.cas.web.authentication.ServiceAuthenticationDetails#getServiceUrl()} will be used for the service url.
 * <p>
 ...
 * {@link org.springframework.security.cas.web.authentication.ServiceAuthenticationDetails#getServiceUrl()} as the service when validating the ticket.
...
public class CustomCasAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    protected final void successfulAuthentication(HttpServletRequest request,
        ...
        // OPH ARK-108 kÃ¤yttÃ¤jÃ¤nimi logitukseen - set
    ...
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException {
        try {
            ...
            // OPH ARK-108 kÃ¤yttÃ¤jÃ¤nimi logitukseen - unset after processing request
            usernameToThreadname(false);
        }
    }

    private void usernameToThreadname(boolean set) { // OPH ARK-108 kÃ¤yttÃ¤jÃ¤nimi logitukseen
