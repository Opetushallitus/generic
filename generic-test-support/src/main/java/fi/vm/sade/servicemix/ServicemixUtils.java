...
//        smxStartAndInstallDaemon();
    ...
    public ServicemixUtils smxInstall() throws Exception {
        ...
        System.out.println("installing bundles to servicemix done.");
        installed = true;
        return this;
    }

    public void smxInstallDaemon() {
...
//        new ServicemixUtils().smxInstall().waitUntilReadyOrStoppedOrInstalled("SMXSTARTINSTALL");
//    }
        ...
        Thread thread = new Thread() {
            ...
            public void run() {
                while (true) {
                    try {
                        Thread.sleep(millis);
                        //System.err.println("sendKeysToProcess: "+str);
                        out.write(str);
                        out.flush();
                    } catch (Exception e) {
                        System.err.println("ERROR in sendKeysToProcess: " + e);
                        //throw new Error(e);
                    }
                }
            }
